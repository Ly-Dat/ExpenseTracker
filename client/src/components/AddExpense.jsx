...
function AddExpense() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Cộng dồn total (sử dụng giá trị tuyệt đối để tránh âm)
      setCumulativeTotal((prevTotal) => prevTotal + Math.abs(formData.value));
      ...
      const errorMsg = err.response?.data?.msg || err.message || 'Error adding expense';
      setError(errorMsg);
  ...
  return (
    <>
      <button id="add-expense-btn" onClick={openModal}>
        <p style={{ fontSize: '18px' }}>-</p>
      </button>
      <div id="expense-modal" className={`modal ${isOpen ? 'open' : ''}`}>
        <div className="modal-content">
          <div className="modal-header">
            <h2 style={{ color: '#E55D87' }}>NEW EXPENSE</h2>
          ...
          <form id="expense-form" onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <select id="category" name="category" required>
                ...
                <option value="shopping">Shopping, Food, Pets</option>
            ...
            <div className="form-group">
              ...
              <div className="expense-toggle">
                <input type="checkbox" id="refund2" name="refund" />
                <label htmlFor="refund2" className="expense-toggle-label expense-refund-toggle" />
              </div>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <div className="expense-toggle">
                <input type="checkbox" id="checked2" name="checked" defaultChecked />
                <label className="expense-toggle-label expense-checked-toggle" htmlFor="checked2" />
              </div>
            </div>
            <div className="form-group">
              <label htmlFor="date">
            ...
            <div className="modal-footer">
              ...
              <button type="submit" className="save-btn" style={{ backgroundColor: '#E55D87' }}>
                Save
              </button>
              <button type="submit" className="save-add-btn" style={{ backgroundColor: '#E55D87' }}>
                Save +
              </button>
            </div>
          </form>
